...
class Downloader:
    def __init__(self, pool_size, retry=3):
        ...
        self.retry = retry
        self.dir = Path.home() / "Downloads" / ".cache"
        self.succeed = {}
        self.failed = []
        self.ts_total = 0
        self.outfile_name = ''
...
if __name__ == "__main__":
    # Set the desired M3U8 URL and output file name here.
    m3u8_url = "your_m3u8_url"
    outfile_name = "output_file_name.mp4"
    # Increase the pool_size for more concurrent downloads.
    downloader = Downloader(pool_size=10)
    downloader.run(m3u8_url, outfile_name)
